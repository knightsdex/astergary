  ...
  [864],
  {
    ...
    5971: function (e, t, r) {
      ...
      function P(e, t) {
        ...
        if (
          (N.lastUsedTime || (N.lastUsedTime = Date.now()),
          "string" == typeof F)
        )
          return m(e, j, F, x);
        let L = e.tree,
      ...
      function v(e, t) {
        ...
        if (r.inFlightServerAction) {
          if (
            ...
            r.globalMutable.pendingNavigatePath !== _
          )
            return (
          ...
          r.inFlightServerAction = (0, o.createRecordFromThenable)(b(e, t));
        try {
          let {
            actionResult: t,
            actionFlightData: o,
          ...
          if ("string" == typeof o)
            return (0, c.handleExternalUrl)(e, r, o, e.pushRef.pendingPush);
